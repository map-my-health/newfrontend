...
async componentDidMount(){
  ...
  return (
    ...
    <p>Welcome to Map My Health, a site aimed to help patients in Oregon access health costs, compare pricing and provide a map view of the hospitals that offer the procedures that they are interested in</p>
